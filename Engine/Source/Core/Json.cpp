...
{ 
    bool Json::Load(const std::string& filename, rapidjson::Document& document)
    {
        ...
        {
            std::cerr << "Could not parse json (@document): " << filename << std::endl;
            return false;
        }
        return true;
    }
    ...
    bool Read(const rapidjson::Value& value, const std::string& name, int& data, bool isRequired)
    {
        ...
        {
            if (isRequired) std::cerr << "Could not read json value (@int): " << name << std::endl;
            return false;
        }
    ...
    bool Read(const rapidjson::Value& value, const std::string& name, bool& data, bool isRequired)
    {
        ...
        {
            if (isRequired) std::cerr << "Could not read json value (@bool): " << name << std::endl;
            return false;
        }
    ...
    bool Read(const rapidjson::Value& value, const std::string& name, float& data, bool isRequired)
    {
        if (!value.HasMember(name.c_str()) || !value[name.c_str()].IsNumber())
        {
            if (isRequired) std::cerr << "Could not read json value (@float): " << name << std::endl;
            return false;
        }
    ...
    bool Read(const rapidjson::Value& value, const std::string& name, Vector2& data, bool isRequired)
    {
        ...
        {
            if (isRequired) std::cerr << "Could not read Json value (@Vector2): " << name << std::endl;
            return false;
        }
        ...
        for (rapidjson::SizeType i = 0; i < array.Size(); i++)
        {
            if (!array[i].IsNumber())
            {
                std::cerr << "Could not read Json value (@Vector2 : ArrayNumber): " << name << std::endl;
                return false;
            }
    ...
    bool Read(const rapidjson::Value& value, const std::string& name, Color& data, bool isRequired)
    {
        ...
        {
            if (isRequired) std::cerr << "Could not read Json value (@Color): " << name << std::endl;
            return false;
        }
        ...
        for (rapidjson::SizeType i = 0; i < array.Size(); i++)
        {
            if (!array[i].IsNumber())
            {
                std::cerr << "Could not read Json value (@Color : ArrayNumber): " << name << std::endl;
                return false;
            }
    ...
    bool Read(const rapidjson::Value& value, const std::string& name, Rect& data, bool isRequired)
    {
        ...
        if (!value.HasMember(name.c_str()) || !value[name.c_str()].IsArray() || value[name.c_str()].Size() != 4)
        {
            if (isRequired) std::cerr << "Could not read Json value (@Rect): " << name << std::endl;
            return false;
        }
    ...
    bool Read(const rapidjson::Value& value, const std::string& name, std::vector<int>& data, bool isRequired)
    {
        ...
        {
            if (isRequired) std::cerr << "Could not read Json value (@vector): " << name << std::endl;
            return false;
        }
        ...
        for (rapidjson::SizeType i = 0; i < array.Size(); i++)
        {
            if (!array[i].IsInt())
            {
                std::cerr << "Could not read Json value (@vector : ArrayNumber): " << name << std::endl;
                return false;
            }
